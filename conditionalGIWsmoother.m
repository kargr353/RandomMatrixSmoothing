function [msm,Psm,vsm,Vsm] = conditionalGIWsmoother(mpred,Ppred,vpred,Vpred,mup,Pup,vup,Vup,models)
...
for t = t_last_update-1:-1:1
    ...
    [msm(:,t),Psm(:,:,t),vsm(t),Vsm(:,:,t)] = conditionalGIWsmoothing(...
